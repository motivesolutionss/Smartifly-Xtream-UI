...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const value = React.useMemo(
    () => ({
      state: (_open ? "expanded" : "collapsed") as "expanded" | "collapsed",
      open: _open,
      setOpen,
      openMobile,
      setOpenMobile,
    ...
    [_open, setOpen, openMobile, setOpenMobile, isMobile, toggleSidebar]
  );
    ...
    <SidebarContext.Provider value={value}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn("group/sidebar-wrapper flex min-h-svh w-full has-[[data-sidebar=sidebar]]/sidebar-wrapper:lg:pl-[--sidebar-width]", className)}
          ref={ref}
          {...props}
        >
          {children}
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  if (collapsible === "none") {
    return (
      <div
        ...
        className={cn("group peer hidden lg:block text-sidebar-foreground", className)}
        {...props}
      >
        {children}
      </div>
  ...
  if (isMobile) {
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <div className="flex h-full w-full flex-col gap-2 overflow-y-auto px-3 py-2 group-data-[collapsible=icon]:overflow-y-visible">
            {children}
          </div>
        </SheetContent>
      </Sheet>
  ...
  return (
    <div
      ...
      data-mobile={isMobile}
      className={cn(
        "group peer hidden lg:block text-sidebar-foreground transition-[width] duration-200 ease-linear",
    ...
    return (
      <button
        ...
        className={cn(
          ...
          "[[data-sidebar=sidebar][data-collapsible=icon]_&]:cursor-pointer [[data-sidebar=sidebar][data-collapsible=icon]_&]:opacity-100 [[data-sidebar=sidebar]:not([data-collapsible=icon])_&]:cursor-default [[data-sidebar=sidebar]:not([data-collapsible=icon])_&]:opacity-0",
          className
        )}
        {...props}
      />
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] lg:peer-data-[variant=inset]:m-2 lg:peer-data-[variant=inset]:ml-0 lg:peer-data-[variant=inset]:rounded-xl lg:peer-data-[variant=inset]:shadow",
          className
        )}
        {...props}
      />
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <div
        ...
        data-state={state}
        className={cn(
          "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden group-data-[collapsible=icon]:overflow-y-visible",
          className
        )}
        {...props}
      />
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      {!isIcon && (
        <>
          <Skeleton className="h-4 flex-1 max-w-[80%] rounded-md" />
