        ...
        return (
            ...
            >
                ...
                <View style={styles.metaRow}>
                    {item.isBroadcast && (
                        <View style={[styles.statusTag, styles.statusTagSystem]}>
                            <Text style={[styles.statusTagText, styles.statusTagTextSystem]}>SYSTEM</Text>
                        </View>
                    )}
                    {item.type && (
                    ...
                    {item.priority && (
                        <View style={[
                            styles.statusTag,
                            isUrgent && styles.statusTagUrgent
                        ]}>
                            <Text style={[
                                styles.statusTagText,
                                isUrgent && styles.statusTagTextUrgent
                            ]}>
                                {item.priority}
                            </Text>
                        </View>
