...
import { colors, scale, scaleFont, Icon, uiTokens } from '../../theme';
...
import {
    ...
    XtreamMovie,
    XtreamSeries,
} from '@smartifly/shared/src/api/xtream';
...
const TVSearchScreen: React.FC<TVSearchScreenProps> = ({ focusEntryRef }) => {
    ...
    // Search effect based on debounced query
    useEffect(() => {
        if (debouncedQuery.trim().length > 1) { // Search after 2 chars
                ...
                <View style={styles.searchBarWrapper}>
                    ...
                    <View style={styles.searchBarContainer}>
                        ...
                        <View style={styles.searchIconContainer}>
                            <Icon name="search" size={scale(24)} color={uiTokens.white} />
                        </View>
                        ...
                        {query.length > 0 && (
                            <View style={styles.clearIconContainer}>
                                <Icon name="x" size={scale(20)} color={uiTokens.overlayWhite50} />
                            </View>
                        )}
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    leftPanel: {
        ...
        borderRightWidth: 1,
        borderRightColor: uiTokens.overlayWhite10,
        zIndex: 10,
    },
    rightPanel: {
    ...
    inputText: {
        flex: 1,
        color: uiTokens.white,
        fontSize: scaleFont(20),
        fontWeight: '500',
    },
    placeholderText: {
        color: uiTokens.overlayWhite30,
    },
    clearIconContainer: {
        marginLeft: scale(8),
    },
    ...
    suggestionButton: {
        backgroundColor: uiTokens.overlayWhite10,
        paddingVertical: scale(8),
        paddingHorizontal: scale(16),
        borderRadius: scale(20),
        borderWidth: 1,
        borderColor: uiTokens.overlayWhite20,
    },
