 ...
 * 
 * Base Design: 1920Ã—1080 (Full HD)
 * - All dimensions are authored at FHD
 * - Scale factor applied for other resolutions
 * - Perfect 2Ã— scaling for 4K (3840Ã—2160)
 * 
 * Supported Resolutions:
 * - HD:   1280Ã—720  (0.67Ã— scale)
 * - FHD:  1920Ã—1080 (1.0Ã— scale - base)
 * - 4K:   3840Ã—2160 (2.0Ã— scale)
 * - 8K:   7680Ã—4320 (4.0Ã— scale - OS upscale)
 * 
 * @enterprise-grade
 */
 ...
 * Based on FHD (1920Ã—1080) as 1.0Ã—
 */
