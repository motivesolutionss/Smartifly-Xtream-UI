...
const TVContentCard: React.FC<TVContentCardProps> = ({
  ...
  const shadowRadiusFocused = useMemo(() => scale(18), []);
  const ringWidthFocused = useMemo(() => scale(3.5), []);
  ...
  const cardAnimatedStyle = useAnimatedStyle(() => {
    ...
    return {
      ...
      shadowRadius: isFocused ? shadowRadiusFocused : 0,
      shadowOffset: { width: 0, height: 0 },
      shadowColor: isLive ? liveColor : accentColor,

      // Android
      elevation: isFocused ? 14 : 0,
    };
  }, [disableZoom, isLive, liveColor, accentColor]);
  ...
  }, [disableZoom, focused, ringOpacity, ringWidth, ringWidthFocused, overlayOpacity, zoom]);
  ...
  }, [disableZoom, focused, ringOpacity, ringOpacityIdle, ringWidth, ringWidthIdle, overlayOpacity, zoom]);
  ...
  return (
    <Pressable
      ...
      onFocus={handleFocus}
      onBlur={handleBlur}
      style={[styles.container, containerSizeStyle]}
    >
      <Animated.View
        style={[
          styles.cardBase,
